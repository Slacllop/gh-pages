        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8 mt-5">
                        ...
                        <div>
                            <?php
                                ...
                                if (mysqli_select_db($conexion, $bbdd)) {
                                    ...
                                    $consulta="SELECT * FROM fabricantes WHERE cod_fabricante=7 ORDER BY cod_fabricante;";
                                    $consulta2="SELECT * FROM modelos WHERE cod_fabricante=7";
                                    ...
                                    if (mysqli_errno($conexion)!=0){
                                        ...
                                        echo "<h1 class='fw-bold pt-5'>Orbegozo: Una de las mejores opciones de estufas</h1>";  
                                    }
                    ...
                    <div>
                        <p class="texto">
                            Orbegozo cuenta con más de 70 años de experiencia. Esto les ha ayudado a consolidarse eb el mercado y poder ofrecer a sus usuarios una gran variedad de productos y servicios para el hogar con un buen precio respecto a otros competidores.
                        </p>
                        <p class="texto pb-5">
                            Consolidada como una de las marcas referencia en el ámbito nacional, te ofrece las mejores estufas para no pasar frío en casa este invierno.
                        </p>
                    </div>
                    <div class="pt-3">
                        <img class="w-100 mx-auto d-block" src="fotos/orbegozo_foto.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
