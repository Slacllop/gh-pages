        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8 mt-5">
                        ...
                        <div>
                            <?php
                                ...
                                if (mysqli_select_db($conexion, $bbdd)) {
                                    ...
                                    $consulta="SELECT * FROM fabricantes WHERE cod_fabricante=4 ORDER BY cod_fabricante;";
                                    $consulta2="SELECT * FROM modelos WHERE cod_fabricante=4";
                                    ...
                                    if (mysqli_errno($conexion)!=0){
                                        ...
                                        echo "<h1 class='fw-bold pt-5'>Ferroli: Calidad y mejora constante</h1>"; 
                                    }
                    ...
                    <div>
                        <p class="texto">
                            Ferroli es una empresa multinacional fundada en San Bonifacio (Verona), en 1955. Se especializan en la fabricación y comercialización de soluciones de calefacción y climatización, tanto a nivel doméstico como industrial.
                        </p>
                        <p class="texto">
                           Tienen un centro productivo de última tecnología ubicado en Burgos, además de 7 delegaciones comerciales que dan cobertura a todo el país y más de 150 centros de asistencia técnica repartidos por toda España.
                        </p>
                        <p class="texto pb-5">
                           Ferroli está presente en España desde 1965 y, desde entonces, han invertido en personas, tecnología y conocimiento para ser un referente del sector nacional de la calefacción, climatización y energía solar.
                    </div>
                </div>
            </div>
        </div>
