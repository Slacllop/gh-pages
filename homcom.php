        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8 mt-5">
                        ...
                        <div>
                            <?php
                                ...
                                if (mysqli_select_db($conexion, $bbdd)) {
                                    ...
                                    $consulta="SELECT * FROM fabricantes WHERE cod_fabricante=6 ORDER BY cod_fabricante;";
                                    $consulta2="SELECT * FROM modelos WHERE cod_fabricante=6";
                                    ...
                                    if (mysqli_errno($conexion)!=0){
                                        ...
                                        echo "<h1 class='fw-bold pb-4'>Catálogo</h1>";
                                        echo "<br>";
                                        ...
                                        echo "<h1 class='fw-bold'>Homcom: ¿Las mejores estufas?</h1>";  
                                    }
                    ...
                    <div>
                        <p class="texto">
                            Las estufas eléctricas de la marca Homcom cuentan con unos diseños espectaculares y minimalistas, tanto en el catálogo de estufas como en el de chimeneas eléctricas. 
                        </p>
                        <p class="texto">
                           Las estufas Homcom disponen de estufas portátiles, estufas de anclaje y chimeneas eléctricas para incluir en la decoración del propio hogar. Por ello, es importante conocer bien todas las características de las estufas eléctricas Homcom para elegir siempre la estufa eléctrica adecuada para calentar tu casa
                        </p>
                    </div>
                </div>
            </div>
