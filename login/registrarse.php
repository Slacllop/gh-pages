<?php
  ...
  if ($conexion=mysqli_connect($servidor, $usuario, $clave, $bbdd)) {
    ...
    // 3.- Definimos la consult

    $consulta="INSERT INTO login (nombre, contraseña) VALUES ('$nombre', '$contraseña');";
                ...
                <div class="contact contact-centrado">
                    <div class="contact-w3lsleft">
                        <div class="contact-grid agileits">
                            ...
                            if (isset($_POST["Enviar"])) {
                                if($message > 0){
                                    echo"<script>alert('Usuario creado correctamente'); window.location='../index.php';</script>"; 
                                }else{
                                    echo"<script>alert('Pruebe de nuevo con otro usuario'); window.location='registrarse.php';</script>";
                                }  
                            }
                            ...
                            <form action="registrarse.php" method="POST">
                                ...
                                <input type="text" name="contraseña" placeholder="Contraseña *" required="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Mínimo 8 caracteres, minimo un numero, una mayuscula y una minuscula">
