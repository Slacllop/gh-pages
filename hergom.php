        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8 mt-5">
                            ...
                            <?php
                                ...
                                if (mysqli_select_db($conexion, $bbdd)) {
                                    ...
                                    if (mysqli_errno($conexion)!=0){
                                        ...
                                        echo "<h1 class='fw-bold pt-5'>Hergom: Éxito es su apellido</h1>";  
                                    }
                    ...
                    <div>
                        <p class="texto">
                            A lo largo de 50 años, esta empresa ha acumulado éxitos y mucha experiencia con productos para calefacción de leña y biomasa. Destaca por apostar siempre por los combustibles naturales.
                        </p>
                        <p class="texto">
                            Hergom fue fundada en 1960 en Santander y dedicada, desde sus inicios, a la fabricación de productos de calor para el hogar.
                        </p>
                        <p class="texto pb-5">
                            Estufas Hergom es una de las principales empresas del sector a nivel mundial, y cuenta con cinco puntos de fabricación y operaciones en Europa y América.
                        </p>
                    </div>
                </div>
            </div>
