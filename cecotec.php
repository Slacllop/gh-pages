        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8 mt-5">
                        ...
                        <div>
                            <?php
                                ...
                                if (mysqli_select_db($conexion, $bbdd)) {
                                    ...
                                    $consulta="SELECT * FROM fabricantes WHERE cod_fabricante=5 ORDER BY cod_fabricante;";
                                    $consulta2="SELECT * FROM modelos WHERE cod_fabricante=5";
                                    ...
                                    if (mysqli_errno($conexion)!=0){
                                        ...
                                        echo "<h1 class='fw-bold pt-5'>Cecotec: El lider del mercado</h1>";  
                                    }
                    ...
                    <div>
                        <p class="texto">
                            Desde 1995, trabajan para ofrecer productos de calidad y confianza adaptados a las necesidades cambiantes. Cuentan con una amplia cartera de clientes para los cuales hemos desarrollado electrodomésticos con una gran aceptación en el mercado. 
                        </p>
                        <p class="texto">
                           Consolidados en el ámbito nacional, en Cecotec Distribuyen también internacionalmente y buscamos nuevos retos, oportunidades y mercados donde poder ofrecer productos con un gran valor diferencial.
                        </p>
                    </div>
                </div>
            </div>
